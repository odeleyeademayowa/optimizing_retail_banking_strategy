...
# Use relative path to ensure compatibility with both local and cloud environments
file_path = os.path.join(os.getcwd(), "data", "cluster_rfm.csv")
...
if os.path.exists(file_path):
    ...
    st.error(f"File not found at {file_path}. Please ensure the file is uploaded correctly.")
